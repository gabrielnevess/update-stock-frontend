...
import { inventoryProductInput } from "../../Sidebar/RoutesAdmin";
import { saveProductInput } from "../../../../services/productInputService";
...
const CreateEditProductInput: React.FC = () => {
    ...
    const isValueValid = (errors: FormikErrors<ProductInput>, touched: FormikTouched<ProductInput>, key: string) => {
    ...
    const renderTitle = "Entrada de Produto";
            ...
            <div className={classes.layout}>
                <Paper className={classes.paper}>
                    ...
                    <Formik
                        ...
                        initialValues={initialProductInput}
                        ...
                        onSubmit={async (values, { setSubmitting, setFieldError }) => {
                            try {
                                ...
                                const data = await saveProductInput(object);
                                setSubmitting(false);
                                if (data) {
                                    history.push(inventoryProductInput);
                                    toast.success("Entrada de Produto salvo com sucesso!");
                                }
                            } catch (error) {
                                setSubmitting(false);
...
export default memo(CreateEditProductInput);